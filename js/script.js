...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function initShowcaseCarousel() {
        ...
        // Image rotation data
        const imageData = {
            music: ['images/heyday1.jpg', 'images/theodds2.jpg', 'images/heyday3.jpg', 'images/theodds3.jpg'],
    ...
    if (bringFoodCheckbox && foodDetailsGroup) {
        bringFoodCheckbox.addEventListener('change', function() {
            if (this.checked) {
                ...
                foodDetailsInput.value = ''; // Clear the field when unchecked
            }
        });
    }
    ...
    if (contactForm) {
        contactForm.addEventListener('submit', function(e) {
            ...
            if (name && classValue && message) {
                // Additional validation: if bringing food, must specify what
                ...
                formData.append('Bring Own Food', bringFood);
                formData.append('Food Details', foodDetails);
                ...
                .then(data => {
                    ...
                    if (parsedData.status === 'success') {
                        ...
                        contactForm.reset();
                        foodDetailsGroup.style.display = 'none'; // Hide the field after reset
                    } else {
